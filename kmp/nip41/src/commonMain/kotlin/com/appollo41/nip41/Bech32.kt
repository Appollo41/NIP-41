...
// Verbatim subset of ACINQ bitcoin-kmp Bech32.kt
//   https://github.com/ACINQ/bitcoin-kmp/blob/74641a797f4e258ff93c28219a11b59e51a29554/src/commonMain/kotlin/fr/acinq/bitcoin/Bech32.kt
// Last synced: 2026-05-24.
// Local adaptations (only):
//   - `package` line is `com.appollo41.nip41` (upstream is `fr.acinq.bitcoin`).
//   - Three Bitcoin-specific methods omitted (we don't need them for NIP-19):
//       hrp(BlockHash), encodeWitnessAddress, decodeWitnessAddress.
// All retained declarations are byte-identical to upstream.
...
/**
 * Bech32 works with 5 bits values, we use this type to make it explicit:
 * whenever you see Int5 it means 5 bits values,
 * and whenever you see Byte it means 8 bits values.
 */
internal typealias Int5 = Byte
 ...
 *
 * Internal: NIP-41 consumers reach bech32 through [Nip19], which is the
 * spec-relevant surface. Keeping this object out of the published ABI lets
 * us swap it for a real `bitcoin-kmp` dependency later without breaking
 * consumers.
 */
